    ...
    return (
      <View
        style={{
          ...
          // borderWidth: 1,
          marginLeft: item?.sender == 'customer' ? SizeClass.DEFAULT_MARGIN : 0,
          marginEnd: item?.sender == 'mechanic' ? SizeClass.DEFAULT_MARGIN : 0,
          ...
          alignSelf: item?.sender == 'mechanic' ? 'flex-end' : 'flex-start',
        }}>
        <Text
          style={{
            color:
              item?.sender == 'mechanic' ? ColorConst.white : ColorConst.black,
          }}>
          {item?.text}
        </Text>
        <Text
